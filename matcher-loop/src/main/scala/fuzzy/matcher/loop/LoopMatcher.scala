...
case class LoopMatcher(pattern: Pattern, trace: Boolean = false) extends Matcher {

  // TODO replace trace with proper log support

  import LoopMatcher._
  ...
  def score(text: String): Match = {
    ...
    LoopMatch(matchedTextBuilder.toString, scores(0)(0))
  }
...
case class LoopMatch(matchedText: String, score: Int) extends Match
